...
<template>
    <header class="flex justify-center items-center bg-none">
    <div class="navbar w-[90rem] max-w-[80vw] bg-[var(--bg-card)]/80 shadow-sm rounded-xl">
      <div class="flex-1">
        <h3 class="text-xl font-bold text-[var(--text-main)] ps-3">DEMO</h3>
      </div>
      <div class="flex-none">
